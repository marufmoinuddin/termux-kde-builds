...
pkg install xorgproto libx11 libxext libxrender libxtst libxdamage libxfixes libxrandr libxcomposite libxcursor libxft libxi libxt libxv libxkbfile libxaw libxmu libxpm libxss libxtst libxvmc libxkbcommon libxkbcommon-x11 libice libsm libxcb libxau libxdmcp libxshmfence libglvnd mesa mesa-dev libglvnd-dev -y
pkg install x11-repo tur-repo -y
pkg install kf6* qt6* build-essential extra-cmake-modules ninja libwayland-protocols vulkan-headers plasma-wayland-protocols jq libcap boost boost-headers libxss sdl2 sassc pycairo docbook-xml docbook-xsl itstool libqrencode libzxing-cpp libdmtx liblmdb openexr xwayland libxcvt libdisplay-info gsettings-desktop-schemas duktape libduktape gobject-introspection g-ir-scanner fontconfig-utils -y
pip install meson
...
create_build_sh() {
    ...
    # Download source to get SHA256 if URL is provided
    if [ -n "$src_url" ]; then
        wget -q "$src_url" -O "/tmp/$pkg_name-$version.tar.xz"
        sha256=$(sha256sum "/tmp/$pkg_name-$version.tar.xz" | cut -d' ' -f1)
        rm -f "/tmp/$pkg_name-$version.tar.xz"
    fi
...
declare -A PACKAGES=(
    ["kwayland"]="6.4.2|https://download.kde.org/stable/plasma/6.4.2/kwayland-6.4.2.tar.xz||qt6-base,kf6-kwindowsystem||false"
    ["kdecoration"]="6.4.2|https://download.kde.org/stable/plasma/6.4.2/kdecoration-6.4.2.tar.xz||qt6-base,kf6-kconfig,kde-kwayland|-DBUILD_WITH_QT6=ON|false"
    ["libkscreen"]="6.4.2|https://download.kde.org/stable/plasma/6.4.2/libkscreen-6.4.2.tar.xz||qt6-base,kf6-kconfigwidgets|-DBUILD_WITH_QT6=ON|false"
    ["plasma-activities"]="6.4.2|https://download.kde.org/stable/plasma/6.4.2/plasma-activities-6.4.2.tar.xz||qt6-base,kf6-kconfig,kde-libplasma|-DBUILD_WITH_QT6=ON|false"
    ...
    ["kidletime"]="6.16.0||https://github.com/KDE/kidletime.git|v6.16.0|qt6-base|-DBUILD_WITH_QT6=ON|false"
    ["plasma5support"]="6.4.2|https://download.kde.org/stable/plasma/6.4.2/plasma5support-6.4.2.tar.xz||qt6-base,kf6-kconfig,kf6-kcoreaddons|-DBUILD_WITH_QT6=ON|false"
    ["layer-shell-qt"]="6.4.2|https://download.kde.org/stable/plasma/6.4.2/layer-shell-qt-6.4.2.tar.xz||qt6-base,kf6-kwayland|-DBUILD_WITH_QT6=ON|false"
    ["kcmutils"]="6.16.0||https://github.com/KDE/kcmutils.git|v6.16.0|kf6-kconfig,kf6-kdeclarative|-DBUILD_WITH_QT6=ON|false"
    ["ksvg"]="6.16.0||https://github.com/KDE/ksvg.git|v6.16.0|qt6-base,kf6-karchive|-DBUILD_WITH_QT6=ON|false"
    ["aurorae"]="6.4.2|https://download.kde.org/stable/plasma/6.4.2/aurorae-6.4.2.tar.xz||qt6-base,kf6-kconfigwidgets|-DBUILD_WITH_QT6=ON|false"
    ...
    ["breeze"]="6.4.2|https://download.kde.org/stable/plasma/6.4.2/breeze-6.4.2.tar.xz||qt6-base,kf6-kconfig,kf6-kwindowsystem|-DBUILD_QT6=ON -DBUILD_QT5=OFF|false"
    ["breeze-gtk"]="6.4.2|https://download.kde.org/stable/plasma/6.4.2/breeze-gtk-6.4.2.tar.xz||qt6-base,sassc,pycairo|-DBUILD_WITH_QT6=ON|false"
    ...
    ["qtpositioning"]="6.9.1||https://github.com/qt/qtpositioning.git|v6.9.1|qt6-base||true"
    ["qtlocation"]="6.9.1||https://github.com/qt/qtlocation.git|v6.9.1|qt6-base,kde-qtpositioning||true"
    ["qcoro"]="0.12.0||https://github.com/qcoro/qcoro.git|v0.12.0|qt6-base,kf6-kcoreaddons||true"
    ["libplasma"]="6.4.2||https://github.com/KDE/libplasma.git|v6.4.2|qt6-base,kf6-kconfig,kf6-kwindowsystem|-DBUILD_WITH_QT6=ON|false"
    ...
    ["kdnssd"]="6.16.0||https://github.com/KDE/kdnssd.git|v6.16.0|qt6-base,kf6-kcoreaddons|-DBUILD_WITH_QT6=ON|false"
    ["syntax-highlighting"]="6.16.0||https://github.com/KDE/syntax-highlighting.git|v6.16.0|qt6-base,kf6-kcoreaddons|sed -i 's|add_subdirectory(quick)|#&|' src/CMakeLists.txt|-DBUILD_WITH_QT6=ON|false"
    ...
    ["libkexiv2"]="25.07.80||https://github.com/KDE/libkexiv2.git|v25.07.80|qt6-base,kf6-kcoreaddons|-DBUILD_WITH_QT6=ON|false"
    ["phonon"]="4.12.0||https://github.com/KDE/phonon.git|v4.12.0|qt6-base,pulseaudio-glib|-DPHONON_BUILD_QT5=OFF -DPHONON_BUILD_QT6=ON|false"
    ["kio-extras"]="25.07.80|https://download.kde.org/stable/kio-extras/25.07.80/kio-extras-25.07.80.tar.xz||qt6-base,kf6-kio,openexr|sed -i '/target_link_libraries(kio_thumbnail/a\        android-shmem' thumbnail/CMakeLists.txt|-DBUILD_WITH_QT6=ON|false"
    ...
    ["prison"]="6.16.0||https://github.com/KDE/prison.git|v6.16.0|qt6-base,libqrencode,libzxing-cpp,libdmtx|-DBUILD_WITH_QT6=ON|false"
    ["qtspeech"]="6.9.1||https://github.com/qt/qtspeech.git|v6.9.1|qt6-base||true"
    ...
    ["kuserfeedback"]="6.16.0||https://github.com/KDE/kuserfeedback.git|v6.16.0|qt6-base,kf6-kcoreaddons|-DBUILD_WITH_QT6=ON|false"
    ["qtsensors"]="6.9.1||https://github.com/qt/qtsensors.git|v6.9.1|qt6-base||true"
    ...
    ["kholidays"]="6.16.0||https://github.com/KDE/kholidays.git|v6.16.0|qt6-base|-DBUILD_WITH_QT6=ON|false"
    ...
    ["libqaccessibilityclient"]="master||https://invent.kde.org/libraries/libqaccessibilityclient.git|master|qt6-base||false"
    ["kwin-x11"]="master||https://invent.kde.org/plasma/kwin-x11.git|stable|qt6-base,kf6-kwindowsystem,xwayland,libxcvt,libdisplay-info|sed -i 's|find_package(UDev)|#&|' CMakeLists.txt; sed -i 's|UDev::UDev|#&|' src/CMakeLists.txt; sed -i '/target_link_libraries(kwin/a\        android-shmem' src/CMakeLists.txt; sed -i '/set(kcm_libs/a\        Qt::DBus\n        android-shmem' src/kcms/rules/CMakeLists.txt; git checkout stable|-DBUILD_WITH_QT6=ON -DBUILD_WAYLAND_COMPOSITOR=OFF -DBUILD_KWIN_WAYLAND=OFF -DBUILD_KWIN_X11=ON -DKF6_HOST_TOOLING=\$TERMUX_PREFIX/lib/cmake|false"
    ["kded"]="6.16.0||https://github.com/KDE/kded.git|v6.16.0|kf6-kcoreaddons|-DBUILD_WITH_QT6=ON|false"
    ["appstream"]="master||https://github.com/ximion/appstream.git|master|itstool,qt6-base|meson setup builddir --prefix=\$TERMUX_PREFIX -Dqt=true -Dvapi=false -Ddocs=false -Dapidocs=false -Dgir=true -Dsystemd=false -Dstemming=false; termux_step_make_install() { ninja -j\$(nproc); ninja install DESTDIR=\$TERMUX_PKG_STAGEDIR; }|false"
    ["kquickcharts"]="master||https://github.com/KDE/kquickcharts.git|master|qt6-base,kf6-kcoreaddons|-DBUILD_WITH_QT6=ON|false"
    ["plasma-workspace"]="6.4.2|https://download.kde.org/stable/plasma/6.4.2/plasma-workspace-6.4.2.tar.xz||qt6-base,kf6-kio,kde-kwin-x11|sed -i 's|find_package(KWinDBusInterface CONFIG REQUIRED)|find_package(KWinX11DBusInterface CONFIG REQUIRED)|' CMakeLists.txt; sed -i 's|find_package(UDev REQUIRED)|#&|' CMakeLists.txt; sed -i 's|find_package(PolkitQt6-1)|#&|' CMakeLists.txt; sed -i 's|find_package(KSysGuard|#&|' CMakeLists.txt; sed -i 's|add_subdirectory(region_language)|#&|' kcms/CMakeLists.txt; sed -i 's|add_subdirectory(users)|#&|' kcms/CMakeLists.txt; sed -i 's|PolkitQt6-1::Core|#&|' kcms/region_language/localegenhelper/CMakeLists.txt; sed -i 's|UDev::UDev|#&|' devicenotifications/CMakeLists.txt; sed -i 's|exampleutility.cpp exampleutility.h|#&|' kcms/region_language/CMakeLists.txt; sed -i 's|add_subdirectory(devicenotifications)|#&|' CMakeLists.txt|-DBUILD_WITH_QT6=ON -DBUILD_CAMERAINDICATOR=OFF|false"
    ["plasma-workspace-wallpapers"]="6.4.2|https://download.kde.org/stable/plasma/6.4.2/plasma-workspace-wallpapers-6.4.2.tar.xz||qt6-base|-DBUILD_WITH_QT6=ON|false"
    ...
    ["plasma-integration"]="6.4.2|https://download.kde.org/stable/plasma/6.4.2/plasma-integration-6.4.2.tar.xz||qt6-base,kf6-kio|-DBUILD_QT5=OFF -DBUILD_QT6=ON|false"
    ["milou"]="6.4.2|https://download.kde.org/stable/plasma/6.4.2/milou-6.4.2.tar.xz||qt6-base,kf6-krunner|-DBUILD_WITH_QT6=ON|false"
    ["ocean-sound-theme"]="6.4.2|https://download.kde.org/stable/plasma/6.4.2/ocean-sound-theme-6.4.2.tar.xz||qt6-base|-DBUILD_WITH_QT6=ON|false"
    ["oxygen"]="6.4.2|https://download.kde.org/stable/plasma/6.4.2/oxygen-6.4.2.tar.xz||qt6-base,kf6-kconfigwidgets|-DBUILD_QT5=OFF -DBUILD_QT6=ON|false"
    ["oxygen-sounds"]="6.4.2|https://download.kde.org/stable/plasma/6.4.2/oxygen-sounds-6.4.2.tar.xz||qt6-base|-DBUILD_WITH_QT6=ON|false"
    ["plasma-nano"]="6.4.2|https://download.kde.org/stable/plasma/6.4.2/plasma-nano-6.4.2.tar.xz||qt6-base,kf6-kdeclarative||false"
    ["pulseaudio-qt"]="1.7.0||https://github.com/KDE/pulseaudio-qt.git|v1.7.0|qt6-base,pulseaudio-glib||false"
    ["plasma-pa"]="6.4.2|https://download.kde.org/stable/plasma/6.4.2/plasma-pa-6.4.2.tar.xz||qt6-base,kde-pulseaudio-qt||false"
    ["plasma-welcome"]="6.4.2|https://download.kde.org/stable/plasma/6.4.2/plasma-welcome-6.4.2.tar.xz||qt6-base,kf6-knewstuff||false"
    ["purpose"]="master||https://github.com/KDE/purpose.git|master|kf6-kio,kf6-knewstuff||false"
    ["plasma-browser-integration"]="6.4.2|https://download.kde.org/stable/plasma/6.4.2/plasma-browser-integration-6.4.2.tar.xz||qt6-base,kf6-kio|-DCOPY_MESSAGING_HOST_FILE_HOME=ON|false"
    ["plasma-sdk"]="6.4.2|https://download.kde.org/stable/plasma/6.4.2/plasma-sdk-6.4.2.tar.xz||qt6-base,kf6-kio||false"
    ["qqc2-breeze-style"]="6.4.2|https://download.kde.org/stable/plasma/6.4.2/qqc2-breeze-style-6.4.2.tar.xz||qt6-base,kf6-kirigami||false"
    ["qqc2-desktop-style"]="master||https://github.com/KDE/qqc2-desktop-style.git|master|qt6-base,kf6-kirigami||false"
    ["plasma-desktop"]="6.4.2|https://download.kde.org/stable/plasma/6.4.2/plasma-desktop-6.4.2.tar.xz||qt6-base,kf6-kio,kde-kwin-x11|sed -i 's|find_package(KSysGuard CONFIG REQUIRED)|find_package(KWinX11DBusInterface CONFIG REQUIRED)|' CMakeLists.txt; sed -i 's|find_package(UDev)|#&|' CMakeLists.txt; sed -i 's|PkgConfig::LIBWACOM|#&|' kcms/tablet/CMakeLists.txt; sed -i 's|PkgConfig::LIBWACOM|#&|' applets/taskmanager/CMakeLists.txt|-DBUILD_WITH_QT6=ON -DCMAKE_DISABLE_FIND_PACKAGE_LibWacom=TRUE|false"
    ["systemsettings"]="6.4.2|https://download.kde.org/stable/plasma/6.4.2/systemsettings-6.4.2.tar.xz||qt6-base,kf6-kcmutils,kde-plasma-desktop|-DBUILD_WITH_QT6=ON|false"
)
